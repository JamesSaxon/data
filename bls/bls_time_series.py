...
series = ['LAUCT171400000000003']
reverse_names = {'LAUCT171400000000003' : "Chicago"}


if False: # Get from scratch
    ...
    for y in range(1980, 2016, 5):
      ...
      data = json.dumps({"seriesid": series, "startyear": y, "endyear": ye, 
                         "registrationKey":"ea55a91c96814167aad087d978f4effc"})
